    ...
    begin
      ...
      1 :
        begin 
          ...
          choice := new  TextABC(10,110,10,'Зависимость средненего времени ожидания',clRed);
...
begin
  ...
  text := new TextABC(38,40,12,'Источник1',clBlack);
  text := new TextABC(176,40,12,'Источник2',clBlack);
  
  text := new TextABC(380,10,12,'Буфер',clBlack);
  text := new TextABC(10,10,12,'Вероятность         отказа',clBlack);
  
  text := new TextABC(326,40,12,'Источник1',clBlack);
  text := new TextABC(426,40,12,'Источник2',clBlack);
  for i := 1 to 11 do
  begin
    s := '';
