...
type
  ...
  private
    ...
    times : array [1..sourceCount] of real;
    counts : array[1..sourceCount] of integer;
    count : integer;
  ...
  public
    ...
    begin
      ...
      begin
        ...
        number := main[maxPriority].getSourceNumber();
      end;
      times[number] := times[number] + main[maxPriority].getNextClaimTime() - main[maxPriority].getPrevClaimTime();
