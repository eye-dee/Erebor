...
private
  ...
  middleCountArray : array [1..sourceCount,1..11] of real;
  middleSystem : array [1..sourceCount,1..11] of real;
public
  constructor create();
  var
    i,j : integer;
  ...
  procedure setSystem(i,j : integer;value : real);
  begin
    middleSystem[i,j] := value;
  end;
  function getterSystem(i,j : integer) : real;
  begin
    getterSystem := middleSystem[i,j];
  end;
end;
